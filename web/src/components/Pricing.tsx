    ...
    <div className="relative min-h-screen text-white font-sans" style={{ backgroundColor: '#050505' }}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-3 flex justify-center gap-6 flex-wrap lg:flex-nowrap">
            {creditPackages.slice(3).map((pkg, index) => (
              <motion.div
                key={pkg.credits}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                ...
                className="relative group w-full md:w-[calc(50%-12px)] lg:w-auto lg:max-w-sm"
              >
                {/* Popular Badge */}
                {pkg.badge && (
                  <div className="absolute -top-3 left-0 right-0 flex justify-center z-20">
