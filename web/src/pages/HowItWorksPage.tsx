      ...
      <section className="pt-36 md:pt-48 pb-12 md:pb-20 px-4 text-center relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-[1.1]">
            Zero Friction. <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-sky-200">Maximum Intelligence.</span>
          </h1>
            ...
            {steps.map((step, i) => (
              ...
              >
                <GlassCard className="h-full p-6 md:p-8 hover:border-white/20 transition-colors bg-black/40">
                  ...
                  <div className="text-xs md:text-sm font-mono text-sky-300 mb-2">STEP {step.id}</div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                {features.map((feature, i) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${
                      feature.color === 'gray' ? 'bg-sky-500/15 text-sky-300' :
                      feature.color === 'gray' ? 'bg-sky-500/15 text-sky-300' :
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/15 to-sky-400/10 blur-3xl rounded-full" />
              <GlassCard className="relative p-8 border-white/10 bg-black/60 backdrop-blur-xl">
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-sky-500/10 border border-sky-500/20 rounded-lg">
                    <div className="text-xs text-sky-300 font-bold mb-1">LECTURE DETECTED</div>
