...
const newFeatures = [
  {
    ...
    icon: <Brain className="w-5 h-5 text-sky-300" />,
    items: [
      {
      ...
      <section className="pt-36 md:pt-48 pb-12 md:pb-20 px-4 text-center relative z-10">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-[1.1]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-sky-200">Detection.</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.05] transition-colors">
              <div className="h-12 w-12 rounded-xl bg-sky-500/15 flex items-center justify-center text-sky-300 mb-4">
                <Ghost size={24} />
              </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {section.items.map((feature, j) => (
                  <GlassCard 
                    key={j} 
                    className="p-6 group hover:border-sky-500/30 transition-all duration-300"
                  >
                    <div className="h-10 w-10 rounded-lg bg-sky-500/10 border border-sky-500/20 flex items-center justify-center text-gray-300 group-hover:text-sky-300 group-hover:scale-110 transition-all mb-4">
                      {feature.icon}
                    </div>
