                ...
                {isLanguageDropdownOpen && (
                  <GlassCard style={styles.languageDropdownMenu}>
                    {Object.values(languageCodeToDisplay).map((lang) => (
                      ...
                      >
                        {lang}
                        {language === lang && <CheckIcon size={14} color="rgba(135, 206, 250, 0.9)" />}
                      </div>
                    ))}
                  </GlassCard>
                )}
        ...
        return (
          <div style={styles.animateFade}>
            ...
            <div style={styles.billingGrid}>
              ...
              {/* PRO CARD */}
              <div style={{...styles.planCard, border: '1px solid rgba(135, 206, 250, 0.4)', background: 'rgba(135, 206, 250, 0.08)'}}>
                <div style={{...styles.planName, color: 'rgba(135, 206, 250, 0.9)'}}>{t('scholar_pro')}</div>
            ...
            <div style={styles.inputGroup}>
              ...
              <div style={{display: 'flex', gap: '12px', alignItems: 'center', marginTop: '8px'}}>
                <button 
                  ...
                  style={{
                    ...styles.keybindBtn,
                    borderColor: isRecordingKey ? 'rgba(135, 206, 250, 0.5)' : 'rgba(135, 206, 250, 0.3)',
                    color: isRecordingKey ? 'rgba(135, 206, 250, 1)' : '#fff',
                ...
                {isRecordingKey && (
                  <div style={{fontSize: '12px', color: 'rgba(135, 206, 250, 0.9)', fontStyle: 'italic'}}>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // Buttons
  primaryBtn: { padding: '10px 20px', backgroundColor: 'rgba(135, 206, 250, 0.3)', border: 'none', borderRadius: '8px', color: 'white', fontWeight: 600, cursor: 'pointer', fontSize: '14px' },
